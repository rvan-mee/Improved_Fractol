...
/*   Updated: 2022/08/07 20:12:50 by rvan-mee      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_values(t_hsv *hsv, float r1_v, float g1_v, float b1_v)
{
	hsv->r1 = r1_v;
	hsv->g1 = g1_v;
	hsv->b1 = b1_v;
...
static void	split_rgb(unsigned base_color, t_hsv *hsv_data)
{
...
int32_t	get_rainbow_color(t_root *root, size_t i)
{
	...
	split_rgb(root->r_screen.color, &hsv_data);
	rgb_to_hsv(&hsv_data);
